...
<body class="admin-validation-page" data-spy="scroll" data-target="#nav-spy" data-offset="200">
  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top navbar-shadow" style="text-align: center">
      ...
      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#Change" style="margin-top:1%;">修改封面</button>
      ...
      <div class="modal fade bs-example-modal-lg" id="Change" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-backdrop" role="document" >
          <div class="modal-dialog" style="width:600px;">
            <div class="modal-content">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                      aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">相册封面修改</h4>
              <div>
                <form id="uploadForm" enctype="multipart/form-data">
                  <input type="file" name="file_data" id="file_data" style="margin-left: 10px" <%--class="inputfile"--%> datatype="file"/>
                </form>
                <div>
