                            ...
                            <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                                ...
                                <tbody>
                                    <tr class="message-unread">
                                        ...
                                        <td class=""><c:out value="${user1.user_id}"></c:out></td>
                                        <td class=""><c:out value="${user1.user_name}"></c:out></td>
                                        <td class="hidden-xs">
                                            <span class="badge badge-warning mr10 fs11"><c:out value="${user1.user_email}"></c:out></span>
                                        </td>
                                        <td class=""><c:out value="${user1.count}"></c:out></td>
                                        <td class=""><c:out value="${user1.user_size}"></c:out></td>
                                        <td class="text-center fw600"><c:out value="${user1.user_last_login_time}"></c:out></td>
                                        <td>
                                            <c:if test="${user1.user_status==0}">
                                                <button type="button" class="btn btn-warning">未激活</button>
                                            </c:if>
                                            <c:if test="${user1.user_status==1}">
                                                <button type="button" class="btn btn-danger">封禁</button>
                                            </c:if>
                                            <c:if test="${user1.user_status==2}">
