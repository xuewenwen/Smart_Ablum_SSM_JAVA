  ...
  <script type="text/javascript">
    function doLogin() {
      ...
      if(a!=null||a!=""||b!=null||b!=""){
        window.location.href="/adminLogin?name="+a+"&password="+b;
      }
      else {
        alert("你输入有误，请重新输出！");
      }
          ...
          <div class="panel mt30 mb25">
            ...
            <form method="post" action="list.html" id="contact">
              ...
              <div class="panel-footer clearfix">
                <input type="button" class="button btn-primary mr10 pull-right" value="登陆" onclick="doLogin()">
